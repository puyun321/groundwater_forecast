# -*- coding: utf-8 -*-
"""
Created on Thu Oct 27 14:31:32 2022
...
select_index= train_time[(train_time['date']>=start_date) & (train_time['date']<=end_date)].index-1

#%%
"""choose rainfall event"""
obs_event = P[select_index[0],:]
...
obs_train_z = IDW_interpolation(obs_event,P_station_info,G_grid_lon,G_grid_lat)
...
output_path=r'D:\important\research\groundwater_forecast(monthly)\result\rainfall\train\%s'%(filename)
