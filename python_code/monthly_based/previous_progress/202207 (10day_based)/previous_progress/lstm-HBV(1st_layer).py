...
if __name__ == '__main__':
    ...
    save_path=r"D:\important\research\groundwater_forecast\python_code\puyun\model\1st_layer\dlstm.hdf5"
    ...
    for i in range(0,3):
        writer = pd.ExcelWriter(r"D:\important\research\groundwater_forecast\python_code\puyun\result\1st_layer\forecast(t+%s).xlsx"%(i+1),engine='xlsxwriter')
