...
G01_out1 = G01_new[timestep-2+forecast_timestep[0]:-(timestep-forecast_timestep[0])]; out_difference1=G01_out1[1:,:]-G01_out1[0:-1,:]
G01_out2 = G01_new[timestep-2+forecast_timestep[1]:-(timestep-forecast_timestep[1])]  
G01_out3 = G01_new[timestep-2+forecast_timestep[2]:]  
...
# simulate_test1=pd.read_excel(r"D:\important\research\groundwater_forecast\python_code\puyun\result\1st_layer\simulate(test).xlsx",sheet_name='simulate_result(t+1)')
# ground_obs1=pd.read_excel(r"D:\important\research\groundwater_forecast\python_code\puyun\result\1st_layer\simulate(test).xlsx",sheet_name='groundwater_observation(t+1)')
