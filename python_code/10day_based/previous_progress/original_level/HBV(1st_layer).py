...
for index,optima in enumerate(optima_alltimestep):
    ...
    optima.to_csv(r"D:\important\research\groundwater_forecast\python_code\puyun\original_level\result\1st_layer\optima_parameter(t+%s).csv"%(index+1))
...
for index in range(0,3):
    optima = pd.read_csv(r"D:\important\research\groundwater_forecast\python_code\puyun\original_level\result\1st_layer\optima_parameter(t+%s).csv"%(index+1),index_col=0)
    location=1
...
writer = pd.ExcelWriter(r"D:\important\research\groundwater_forecast\python_code\puyun\original_level\result\1st_layer\simulate(train).xlsx",engine='xlsxwriter')
...
writer = pd.ExcelWriter(r"D:\important\research\groundwater_forecast\python_code\puyun\original_level\result\1st_layer\simulate(test).xlsx",engine='xlsxwriter')
for i,simulate_train_result in enumerate(all_simulate_train_result):
