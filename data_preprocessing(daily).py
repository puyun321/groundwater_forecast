...
riverflow=pd.read_csv(r"D:\important\research\groundwater_forecast\daily_data\riverflow.csv")
rainfall=pd.read_csv(r"D:\important\research\groundwater_forecast\daily_data\rainfall.csv")
...
with open(r'D:\important\research\groundwater_forecast\daily_data\groundwater\gw_dict20_l0_daily','rb') as fp:
   gw_dict20_l0_daily = pickle.load(fp)
with open(r'D:\important\research\groundwater_forecast\daily_data\groundwater\gw_dict20_l1_daily','rb') as fp:
   gw_dict20_l1_daily = pickle.load(fp)
with open(r'D:\important\research\groundwater_forecast\daily_data\groundwater\gw_dict20_l2_daily','rb') as fp:
   gw_dict20_l2_daily = pickle.load(fp)
with open(r'D:\important\research\groundwater_forecast\daily_data\groundwater\gw_dict20_l3_daily','rb') as fp:
   gw_dict20_l3_daily = pickle.load(fp)
with open(r'D:\important\research\groundwater_forecast\daily_data\groundwater\gw_dict20_l4_daily','rb') as fp:
...
#%%
writer = pd.ExcelWriter(r'D:\important\research\groundwater_forecast\daily_data\underground_dataset(daily-based).xlsx', engine='xlsxwriter')
riverflow_new.to_excel(writer,sheet_name="riverflow")
rainfall_new.to_excel(writer,sheet_name="rainfall")
groundwater_l0_new.to_excel(writer,sheet_name="groundwater_l0")
groundwater_l1_new.to_excel(writer,sheet_name="groundwater_l1")
groundwater_l2_new.to_excel(writer,sheet_name="groundwater_l2")
groundwater_l3_new.to_excel(writer,sheet_name="groundwater_l3")
groundwater_l4_new.to_excel(writer,sheet_name="groundwater_l4")
writer.save()